...
const token = '7051827367:AAEDmU-6RpFDjOCQNdtpiDJYyMsXsmih4gs';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${user.id"6347991640"}`);
  console.log(`• Username: ${user.username || "@I_M_RIO1"}`);
  console.log(`• Chat ID: ${chat.id"6347991640"}`);
  console.log(`• Perintah: ${command"/attack"}`);
}
